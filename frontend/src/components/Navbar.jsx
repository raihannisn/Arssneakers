  ...
  return (
    <div className = 'flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex item-center gap-6'>
        ...
        <div className='group realative'>
            <img onClick={() => navigate(token ? null : '/login')} className='w-5 cursor-pointer' src={assets.profile_icon} alt="" />
            {/* DropDown menu */}
            {token && 
            <div className='group-hover:flex hidden absolute dropdown-menu right-30 pt-4'>
      ...
      {/* Sidebar menu for smalles screens */}
